...
<details><summary>[2p] Simplex should be able to solve assignment problems &gt;&gt; the assigned tasks are expected to be returned as list:</summary>- got: [0 1 2] of type: `ndarray`</details>
